...
Every time the system drafts something that isn't quite you, log the fix here. This is the raw material the weekly retrain ritual distills into `rules.md` and `examples.md`. Don't edit the rules directly mid-week — just log, then distill on a cadence.

| Date | Email type | What the AI wrote (off) | What I changed it to (me) | The lesson |
|------|-----------|--------------------------|----------------------------|------------|
