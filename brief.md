...
**What I've tried.** Quick prompts like "write a friendly reply."  Pasting one old email.  Closer, but still not me — it misses my brevity, my plain parentheses, my numbered options, my quick "Let me know."  No memory — every session starts from zero.

**What I need.** A specialist that holds my voice — pulled from my own sent email — and drafts customer and B2B replies in it.  It gets sharper as I log fixes.  Once the routine email drafts itself, I'll have more time for marketing, promos, newsletters.

**Desired output.** Drafts I send in under two minutes.  Success: a regular customer can't tell my reply from the folder's.
